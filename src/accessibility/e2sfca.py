...
def e2sfca(
    ...
    *,
    ...
    # Preserve zero-access origins explicitly. Dropping them would bias municipal summaries upward.
...
def compare_seasons(
    ...
    *,
    ...
    wide["flood_rank"] = wide.groupby(service_type_col)[flood_label].rank(method="average", ascending=False)
    wide["dry_rank"] = wide.groupby(service_type_col)[dry_label].rank(method="average", ascending=False)
